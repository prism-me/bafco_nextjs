...
function Breadcrumb(props) {
    ...
    const { prev, next, current, currentCategory, fullWidth = false } = props;
        ...
        <nav className="breadcrumb-nav">
            <div className={'d-flex align-items-center ' + (fullWidth ? 'container-fluid' : 'container')}>
                <ol className="breadcrumb">
                    ...
                    <li className="breadcrumb-item">
                        <ALink href="/product/default/dark-yellow-lace-cut-out-swing-dress">{currentCategory === "" ? "Product" : currentCategory}</ALink>
                    </li>
