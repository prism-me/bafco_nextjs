                        ...
                        <div className="col-sm-6 col-lg-3">
                            <div className="widget widget-about">
                                ...
                                <div className="widget-about-info">
                                    ...
                                    <ALink href="https://www.instagram.com/bafco/" className="social-icon social-instagram" rel="noopener noreferrer" title="Instagram" target="_blank"><i className="icon-instagram"></i></ALink>
                                    ...
                                    <ALink href="https://www.pinterest.com/bafcointeriors/" className="social-icon social-pinterest" rel="noopener noreferrer" title="pinterest" target="_blank"><i className="icon-pinterest"></i></ALink>
                        ...
                        <div className="col-sm-4 col-lg-2">
                            <div className="widget">
                                ...
                                <ul className="widget-list">
                                    ...
                                    <li><ALink href="/policies/terms-of-service">Terms & Condition</ALink></li>
