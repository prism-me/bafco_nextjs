    ...
    return (
        <div className="product product-11 text-center">
            <figure className="product-media">
                ...
                <ALink href={ `/collections/chairs/${product.slug}` }>
                    <LazyLoadImage
                        alt="product"
            ...
            <div className="product-body">
                ...
                <h3 className="product-title">
                    <ALink href={ `/collections/chairs/${product.slug}` }>{ product.name }</ALink>
                </h3>
            ...
            </div>
            {
                product.stock && product.stock !== 0 ?
                    <div className="product-action">
                        {
                            product.variants.length > 0 ?
                                <ALink href={ `/collections/chairs/${product.slug}` } className="btn-product btn-cart btn-select">
