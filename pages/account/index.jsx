...
function MyAccount(props) {
  ...
  const [userResetPassData, setUserResetPassData] = useState({
  ...
  useEffect(() => {
    ...
    if (GuestUserId !== null && xauthtoken !== null) {
      API.get(`/guest-cart/${GuestUserId}`, {
  ...
  function handelContinueWithCart(e, status) {
    ...
    API.post(`/auth/get-guest-cart`, formdata, {
      headers: { Authorization: `Bearer ${xauthtoken}` },
    })
      .then((response) => {
  ...
  useEffect(() => {
    ...
    if (isEdit) {
      API.get(`/address-detail/${editAddressID}`, header)
        .then((response) => {
  ...
  const handleResetPassword = () => {
    ...
    if (
      userResetPassData?.password !== "" &&
      userResetPassData?.newpassword !== "" &&
      userResetPassData?.confirmpassword !== "" &&
      userResetPassData?.newpassword === userResetPassData?.confirmpassword &&
      userResetPassData?.password !== userResetPassData?.newpassword &&
      userResetPassData?.newpassword.length >= 6
    ) {
      setLoading(true);
      ...
      if (userResetPassData?.password === "") {
        ...
        userResetPassData?.confirmpassword !== userResetPassData?.newpassword
      ) {
                  ...
                  >
                    <div className="tab-pane">
                                      ...
                                      "ORDERCANCELLLATIONREQUEST" ? (
                                        <td className="td_product">
                                          <span className="text-danger">
                                            Your Order Cancellation Request is
                                            under Process
                                          </span>
                                        </td>
                                      ) : (
                                ...
                                <div className="orderdetailbody">
                                  <div>
                                    <div className="row">
                                      ...
                                      <div className="col">
                                        <p>
                                          {singleOrderDetails?.order_number}
                                        </p>
                                      </div>
                                      <div className="col-lg-3 col-md-6 col-sm-6 col-12">
                                      ...
                                      <div className="col">
                                        <p>
                                          {singleOrderDetails?.shipping_charges}
                                        </p>
                                      </div>
                                    </div>
                                    <div className="row">
                                      ...
                                      <div className="col-lg-3 col-md-6 col-sm-6 col-12">
                                        <p>
                                          {
                                            singleOrderDetails?.user_detail
                                              ?.name
                                          }
                                        </p>
                                      </div>
                                    ...
                                    <div id="table-scroll">
                                      <table className="orderDetailsTableClient table">
                                        ...
                                        <tbody className="orderDetailModelTableBody">
                                          {singleOrderDetails?.order_details?.map(
                                            (item, index) => (
                                              <tr key={index}>
                      ...
                      <TabPanel>
                        ...
                        <button
                          className="btn btn-outline-primary-2 mb-3"
                          onClick={openModal}
                        >
                          ADD NEW ADDRESS
                        </button>
                                ...
                                address.default === 1 && (
                                  ...
                                  >
                                    <div className="card-body">
                                      ...
                                      <div
                                        className="address_actions align-items-center"
                                        style={{
                                          display: "flex",
                                      ...
                                      >
                                        <button
                                          onClick={(e) =>
                                            handleEditAddress(e, address.id)
                                          }
                                        ...
                                        >
                                          Delete <i className="icon-edit"></i>
                                        </ALink>
                                        <div
                                          style={{
                                            display: "flex",
                                  ...
                                  >
                                    <div className="card-body">
                                      ...
                                      >
                                        ...
                                        <button
                                          onClick={(e) =>
                                            handleAddressDelete(e, address.id)
                                          }
                                          style={{ fontWeight: "600" }}
                                        >
                                          Delete <i className="icon-edit"></i>
                          ...
                          <div className="modal-content">
                            <div className="orderdetailModelheader modal-header">
                              ...
                              <button
                                type="button"
                                className="close"
                                onClick={closeGuestUserCartListModal}
                              >
                                <span aria-hidden="true">×</span>
                                <span className="sr-only">Close</span>
                              </button>
                            ...
                            <div className="orderdetailModelheader modal-footer">
                              ...
                              <a
                                ...
                                class="btn btn-outline-primary-2 btn-order btn-block"
                                onClick={(e) =>
                                  handelContinueWithCart(e, false)
                                }
                                style={{ width: "200px" }}
                              >
                                Cancel
