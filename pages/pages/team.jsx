...
function Team() {
  ...
  useEffect(() => {
    ...
    axios
      .get("https://endpoint.bafco.com/v1/api/teams")
        ...
        <div className="bg-light-2 pb-7">
          <div className="container">
            ...
            <p className="text-center mb-4">
              We’re a furniture-loving, creative bunch who love to sing and
              dance, listen to music, bake cakes, and cuddle with our pets.
            </p>
            <div className="row">
