            ...
            <div className="page-content">
                <div className="container">
                    ...
                    <div className="rte">
                        ...
                        <p>These Terms do not affect your statutory rights. By accessing, using, or registering for a Site, you agree to be bound by these Terms that govern all transactions via the Site. If you are unwilling to be bound by these Terms, you should not access, use, or register for the Site. These Terms of Service apply to all users of the site, including without limitation users who are browsers, vendors, customers, merchants, and/ or contributors of content.</p>
                        ...
                        <h6 className="mt-3">SECTION 1 - ONLINE STORE TERMS</h6>
                        <p> By agreeing to these Terms of Service, you represent that you are at least the age of majority in your state or province of residence, or that you are the age of majority in your state or province of residence and you have given us your consent to allow any of your minor dependents to use this site. In accordance with the laws of UAE, minors under the age of 18 shall be prohibited to register as a User of this website and are not allowed to transact or use the website.
                        ...
                        <h6 className="mt-3">SECTION 2 - GENERAL CONDITIONS</h6>
                        ...
                        <h6 className="mt-3">SECTION 3 - ACCURACY, COMPLETENESS AND TIMELINESS OF INFORMATION</h6>
                        ...
                        <h6 className="mt-3">SECTION 4 - MODIFICATIONS TO THE SERVICE AND PRICES</h6>
                        ...
                        <h6 className="mt-3">SECTION 5 - PRODUCTS OR SERVICES</h6>
                        ...
                        <h6 className="mt-3">SECTION 6 - ACCURACY OF BILLING AND ACCOUNT INFORMATION</h6>
                        ...
                        <h6 className="mt-3">SECTION 7 - OPTIONAL TOOLS</h6>
                        ...
                        <h6 className="mt-3">SECTION 8 - THIRD-PARTY LINKS</h6>
                        ...
                        <h6 className="mt-3">SECTION 9 - USER COMMENTS, FEEDBACK AND OTHER SUBMISSIONS</h6>
                        ...
                        <h6 className="mt-3">SECTION 12 - PROHIBITED USES</h6>
                        ...
                        <h6 className="mt-3">SECTION 13 - DISCLAIMER OF WARRANTIES; LIMITATION OF LIABILITY</h6>
                        <p> We do not guarantee, represent or warrant that your use of our service will be uninterrupted, timely, secure or error-free.
                            ...
                            In no case shall BAFCO, our directors, officers, employees, affiliates, agents, contractors, interns, suppliers, service providers or licensors be liable for any injury, loss, claim, or any direct, indirect, incidental, punitive, special, or consequential damages of any kind, including, without limitation lost profits, lost revenue, lost savings, loss of data, replacement costs, or any similar damages, whether based in contract, tort (including negligence), strict liability or otherwise, arising from your use of any of the service or any products procured using the service, or for any other claim related in any way to your use of the service or any product, including, but not limited to, any errors or omissions in any content, or any loss or damage of any kind incurred as a result of the use of the service or any content (or product) posted, transmitted, or otherwise made available via the service, even if advised of their possibility. Because some states or jurisdictions do not allow the exclusion or the limitation of liability for consequential or incidental damages, in such states or jurisdictions, our liability shall be limited to the maximum extent permitted by laws of UAE. </p>

                        <h6 className="mt-3">SECTION 14 - INDEMNIFICATION</h6>
                        <p>  You agree to indemnify, defend and hold harmless BAFCO and our parent, subsidiaries, affiliates, partners, officers, directors, agents, contractors, licensors, service providers, subcontractors, suppliers, interns and employees, harmless from any claim or demand, including reasonable attorneys’ fees, made by any third-party due to or arising out of your breach of these Terms of Service or the documents they incorporate by reference or your violation of any law or the rights of a third-party. Any dispute or claim arising our of or in connection with this website shall be governed and construed in accordance with the laws of UAE. United Arab Emirates is BAFCO Trading LLC country of domicile.</p>

                        <h6 className="mt-3">SECTION 15 - SEVERABILITY</h6>
                        <p> In the event that any provision of these Terms of Service is determined to be unlawful, void or unenforceable, such provision shall nonetheless be enforceable to the fullest extent permitted by applicable law, and the unenforceable portion shall be deemed to be severed from these Terms of Service, such determination shall not affect the validity and enforceability of any other remaining provisions.</p>

                        <h6 className="mt-3">SECTION 16 - TERMINATION</h6>
                        ...
                        <h6 className="mt-3">SECTION 17 - ENTIRE AGREEMENT</h6>
                        ...
                        <h6 className="mt-3">SECTION 18 - GOVERNING LAW</h6>
                        <p>  These Terms of Service and any separate agreements whereby we provide you Services shall be governed by and construed in accordance with the laws of BAFCO Trading LLC, BAFCO Interiors, Karama Furniture Mall, Oud Metha, 15556 Dubai DU, United Arab Emirates. United Arab of Emirates is our country of domicile.</p>

                        <h6 className="mt-3">SECTION 19 - CHANGES TO TERMS OF SERVICE</h6>
                        ...
                        <h6 className="mt-3">SECTION 20 - CONTACT INFORMATION</h6>
                        <p> Questions about the Terms of Service should be sent to us at hello@bafco.com.</p>
                    </div>
                </div>
            </div>
