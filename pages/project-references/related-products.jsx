...
function RelatedProducts(props) {
  ...
  const categoryName = product.product_category.parent_category.route;
  const subCategoryName = product.product_category.route;
  ...
  function onQuickView(e) {
    ...
    router.push(
      `/collections/${categoryName}/${subCategoryName}/${product?.route}`
    );
  }
        ...
        product?.productvariations.in_stock == 0 ? (
          <div className="product-price">
            <span className="out-price">
              AED{product?.productvariations.lower_price}
            </span>
          </div>
        ) : product?.productvariations.lower_price ==
          ...
          <div className="product-price">
            ...
            <span className="old-price">
              AED{product?.productvariations.upper_price}
            </span>
          </div>
        ) : (
          <div className="product-price">
